...
// =======
#define HomeScoreUpPin 8
#define HomeScoreDownPin 4
#define HomeGameUpPin 9
#define HomeGameDownPin 5
#define GuestScoreUpPin 12
#define GuestScoreDownPin 7
#define GuestGameUpPin 11
#define GuestGameDownPin 6
// >>>>>>> Stashed changes
...
int HomeScoreUp = LOW;
int HomeScoreDown = LOW;
int HomeGameUp = LOW;
int HomeGameDown = LOW;
int GuestScoreUp = LOW;
int GuestScoreDown = LOW;
int GuestGameUp = LOW;
int GuestGameDown = LOW;
int ResetButton = LOW;
